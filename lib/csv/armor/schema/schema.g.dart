...
Schema _$SchemaFromJson(Map<String, dynamic> json) => Schema(
      ...
      fieldSeparator: $enumDecodeNullable(
              _$FieldSeparatorEnumMap, json['field_separator']) ??
          FieldSeparator.COMMA,
      recordSeparator: $enumDecodeNullable(
              _$RecordSeparatorEnumMap, json['record_separator']) ??
          RecordSeparator.CRLF,
      fieldQuote:
          $enumDecodeNullable(_$FieldQuoteEnumMap, json['field_quote']) ??
              FieldQuote.DQUOTE,
      ...
      foreignKey: (json['foreign_key'] as Map<String, dynamic>?)?.map(
            (k, e) =>
                MapEntry(k, ForeignKey.fromJson(e as Map<String, dynamic>)),
          ) ??
          const {},
    );
...
ForeignKey _$ForeignKeyFromJson(Map<String, dynamic> json) => ForeignKey(
